...
const Title = () => {
    ...
    return (
        <div id="title">
            ...
            <p>
                We're still figuring things out but we thought you deserved a
                dank landing page.
            </p>
            <p>
                For any questions and inquiries email us at <a style={wbreak} href={mail}>support@nasdanq.com</a>
            </p>
            <p>
                Also, visit our <a style={wbreak} href={teespring}>Teespring store</a> for
                some awesome merch!
            </p>
            <hr />
